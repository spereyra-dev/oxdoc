...
pub use models::{
    ...
    DocxTable, DocxTableBlock, DocxTableCell, DocxTableRow, DocxTables, DocxTextOptions,
    DocxVerticalMerge, Extraction, OutputWarning, PptxSlideText, StructuredText, TextBlock,
    XlsxCell, XlsxCellValue, XlsxCsvOptions, XlsxReadOptions, XlsxRow, XlsxRowControl, XlsxSheet,
